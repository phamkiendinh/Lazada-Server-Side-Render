...
<body>
    ...
    <main>
        <div class="container-fluid d-flex flex-column justify-content-center align-items-center gap-5 mb-2 p-auto">
            <button class="btn btn-primary" type="button"><a class="h1 text-light fw-bold" href="addProducts.php">Add Products</a></button>
            <button class="btn btn-primary" type="button"><a class="h1 text-light fw-bold" href="viewProducts.php">View Products</a></button>
